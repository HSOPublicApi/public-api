...
public class EventService extends TemplateMethodService<Event> {
    ...
    public List<Event> findAll() {
        ...
        ResponseEntity<ApiResponse<Event>> response = serviceTemplate.exchange(
                serviceUrl,
                HttpMethod.GET,
                requestEntity,
        ...
        ApiResponse<Event> body = response.getBody();
        List<Event> events = body != null ? body.getData() : Collections.emptyList();
